...
std::array<TerminalTransitionsType const, TerminalTransitionsSize> const TERMINAL_TRANSITIONS = {
 0x09, 0x0A, 0x20, 0x2C, 0x30, 0x5B, 0x5D, 0x09, 0x0A, 0x20, 0x2C, 0x39, 0x5B, 0x5D, 0x01, 0x02, 0x01, 0x03, 0x04, 0x05, 
 0x06
};
...
std::array<RuleParameterIdTableType const, RuleParameterIdTableSize> const RULE_PARAMETER_ID_TABLE = {
 IdConstants::IdSquare, IdConstants::IdLeaf, ReservedIds::IdDefault
};
...
auto SquareTables::fetch_clause(IdType clause_id_) const -> ClauseBase const& {
...
auto SquareTables::get_clause_count() const -> size_t {
 return ClauseCount;
}

auto SquareTables::fetch_rule_parameters(IdType rule_id_) const -> RuleParametersBase const& {
...
auto SquareTables::get_rule_count() const -> size_t {
 return RuleParameterCount;
}

auto SquareTables::get_terminal_state_machine_tables() const -> StateMachineTablesBase const& {
