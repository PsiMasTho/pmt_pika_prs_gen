...
void add_identifier(pmt::rt::Ast& ast_dest_production_, std::string const& rule_name_) {
...
void add_parameters(pmt::rt::Ast& ast_dest_production_, RuleParametersBase const& rule_parameters_, std::string const& rule_name_) {
 ...
 if (rule_parameters_.get_merge() != pmt::rt::RuleParametersBase::MERGE_DEFAULT) {
 ...
 if (rule_parameters_.get_unpack() != pmt::rt::RuleParametersBase::UNPACK_DEFAULT) {
 ...
 if (rule_parameters_.get_hide() != pmt::rt::RuleParametersBase::HIDE_DEFAULT) {
