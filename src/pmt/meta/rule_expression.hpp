...
private:
 ...
 // -$ Functions $-
 // --$ Lifetime $--
 explicit RuleExpression(pmt::rt::ClauseBase::Tag tag_);

public:
 static void destruct(RuleExpression* self_);
 static auto construct(pmt::rt::ClauseBase::Tag tag_) -> UniqueHandle;
 ...
 auto get_tag() const -> pmt::rt::ClauseBase::Tag;
