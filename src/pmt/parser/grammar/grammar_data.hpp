...
class GrammarData {
 ...
 private:
  static void initial_iteration(GrammarData& grammar_data_, GenericAst const& ast_);
  static void initial_iteration_handle_grammar_property(GrammarData& grammar_data_, GenericAst const& ast_, GenericAstPath const& path_);
  static void initial_iteration_handle_grammar_property_start(GrammarData& grammar_data_, GenericAst const& ast_, GenericAstPath const& path_);
  static void initial_iteration_handle_grammar_property_whitespace(GrammarData& grammar_data_, GenericAstPath const& path_);
  static void initial_iteration_handle_grammar_property_comment(GrammarData& grammar_data_, GenericAst const& ast_, GenericAstPath const& path_);
  static void initial_iteration_handle_grammar_property_newline(GrammarData& grammar_data_, GenericAstPath const& path_);
  static void initial_iteration_handle_terminal_production(GrammarData& grammar_data_, GenericAst const& ast_, GenericAstPath const& path_);
  static void initial_iteration_handle_nonterminal_production(GrammarData& grammar_data_, GenericAst const& ast_, GenericAstPath const& path_);
