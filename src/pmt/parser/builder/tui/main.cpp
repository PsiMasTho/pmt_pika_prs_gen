...
auto main(int argc, char const* const* argv) -> int try {
  ...
  LexerTableWriter::WriterArgs table_writer_args{._os_header = lexer_header_file, ._os_source = lexer_source_file, ._is_header_skel = lexer_header_skel_file, ._is_source_skel = lexer_source_skel_file, ._tables = lexer_tables, ._namespace_name = args._namespace_name, ._class_name = args._lexer_class_name, ._header_include_path = std::filesystem::path(args._output_lexer_header_file).filename().string()};
  ...
  ParserTableWriter::WriterArgs parser_writer_args{._os_header = parser_header_file, ._os_source = parser_source_file, ._is_header_skel = parser_header_skel_file, ._is_source_skel = parser_source_skel_file, ._tables = parser_tables, ._namespace_name = args._namespace_name, ._class_name = args._parser_class_name, ._header_include_path = std::filesystem::path(args._output_parser_header_file).filename().string()};
  ...
  IdConstantsWriter::WriterArgs id_constants_writer_args{._os_id_constants = id_constants_file, ._is_id_constants_skel = id_constants_skel_file, ._lexer_tables = lexer_tables, ._parser_tables = parser_tables};
