...
class LexerGraphWriter : public pmt::util::sm::ct::GraphWriter {
 // -$ Types / Constants $-
public:
...
private:
 ...
 // --$ Lifetime $--
public:
 LexerGraphWriter(pmt::util::sm::ct::StateMachine const& state_machine_, std::string const& title_, std::string const& output_filename_, AcceptsToLabelFn terminal_to_name_fn_);
