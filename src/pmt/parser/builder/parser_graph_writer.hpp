...
class ParserGraphWriter : public pmt::util::sm::ct::GraphWriter {
 // -$ Types / Constants $-
public:
...
private:
 ...
 AcceptsToLabelFn _nonterminal_to_name_fn;
 ...
 // --$ Lifetime $--
public:
 ParserGraphWriter(pmt::util::sm::ct::StateMachine const& state_machine_, std::string const& title_, std::string const& output_filename_, AcceptsToLabelFn terminal_to_name_fn_, AcceptsToLabelFn nonterminal_to_name_fn_);
...
private:
 ...
 auto symbol_kind_to_font_color(pmt::util::sm::SymbolKindType kind_) -> Color override;
