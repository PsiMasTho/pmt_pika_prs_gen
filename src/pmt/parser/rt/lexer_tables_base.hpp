...
public:
 ...
 // Linecount tables
 virtual auto get_linecount_state_nr_next(pmt::sm::StateNrType state_nr_, pmt::sm::SymbolType symbol_) const -> pmt::sm::StateNrType = 0;
 virtual auto is_linecount_state_nr_accepting(pmt::sm::StateNrType state_nr_) const -> bool = 0;
};
