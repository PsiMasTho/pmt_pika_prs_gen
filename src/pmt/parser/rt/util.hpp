...
inline auto decode_symbol(pmt::util::sm::SymbolValueType symbol_) -> pmt::util::sm::SymbolValueType;

inline auto lowers_lt(pmt::util::sm::SymbolValueType lhs_, pmt::util::sm::SymbolValueType rhs_) -> bool;

inline auto encode_accept_index(pmt::util::sm::AcceptsIndexType index_) -> pmt::util::sm::AcceptsIndexType;

inline auto decode_accept_index(pmt::util::sm::AcceptsIndexType index_) -> pmt::util::sm::AcceptsIndexType;
