...
namespace pmt::util::smrt {
 ...
 class ParserTablesBase {
  public:
   ...
   virtual auto get_state_terminal_transitions(StateNrType state_nr_) const -> pmt::base::Bitset::ChunkSpanConst = 0; // which terminals can come after this state, if any
   ...
   virtual auto get_min_id() const -> GenericId::IdType;
   virtual auto get_id_count() const -> size_t;

   virtual auto get_lookahead_state_nr_next(StateNrType state_nr_, SymbolType symbol_) const -> StateNrType = 0;
