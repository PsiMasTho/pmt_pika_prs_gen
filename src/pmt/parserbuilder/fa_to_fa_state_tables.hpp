...
class FaToFaStateTables {
  class Context;

 public:
  static void convert(pmt::util::parsect::Fa const& fa_, pmt::util::parsert::GenericFaStateTables& fa_state_tables_);
...
class FaToFaStateTables::Context {
 public:
  Context(pmt::util::parsect::Fa const& fa_, pmt::util::parsert::GenericFaStateTables& fa_state_tables_);
  ...
  pmt::util::parsert::GenericFaStateTables& _tables;
};
