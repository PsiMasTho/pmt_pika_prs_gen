...
void ChoicesExpressionToFaPartFrame::process_stage_0(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
...
void ChoicesExpressionToFaPartFrame::process_stage_1(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  callstack_.push(shared_from_this());
  ++_stage;
...
void ChoicesExpressionToFaPartFrame::process_stage_2(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  --_stage;
  ++_idx;
