...
class GrmNumber {
 public:
  ...
  static auto single_char_as_value(pmt::util::parse::GenericAst const &ast_) -> NumberType;
  ...
  static auto get_repetition_number(pmt::util::parse::GenericAst const &token_) -> std::optional<NumberType>;
  static auto get_repetition_range(pmt::util::parse::GenericAst const &repetition_) -> RepetitionRangeType;
};
