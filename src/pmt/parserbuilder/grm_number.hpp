...
class GrmNumber {
 public:
  ...
  static auto get_repetition_number(pmt::util::parsert::GenericAst const &token_) -> std::optional<NumberType>;
  static auto get_repetition_range(pmt::util::parsert::GenericAst const &repetition_) -> RepetitionRangeType;
};
