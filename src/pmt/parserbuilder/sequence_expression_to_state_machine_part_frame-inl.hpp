...
void SequenceExpressionToFaPartFrame::process_stage_0(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
...
void SequenceExpressionToFaPartFrame::process_stage_1(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  _stage = 0;
  ++_idx;
