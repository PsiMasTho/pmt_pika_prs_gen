...
void RepetitionExpressionToFaPartFrame::process(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  switch (_stage) {
    case 0:
...
void RepetitionExpressionToFaPartFrame::process_stage_0(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
...
void RepetitionExpressionToFaPartFrame::process_stage_1(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  callstack_.push(shared_from_this());
  ++_stage;
...
void RepetitionExpressionToFaPartFrame::process_stage_2(CallstackType& callstack_, ExpressionToStateMachinePartFrameBaseCaptures& captures_) {
  --_stage;
