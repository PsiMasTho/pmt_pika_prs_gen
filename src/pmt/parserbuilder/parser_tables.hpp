...
class ParserTables : public pmt::util::smrt::ParserTablesBase {
  ...
  // -$ Data $-
  std::unordered_map<pmt::util::smrt::StateNrType, pmt::base::Bitset> _lookahead_accepts_bitsets;
  ...
  std::unordered_map<pmt::util::smrt::StateNrType, pmt::base::Bitset> _parser_hidden_terminal_transition_masks;
  ...
  // -$ Functions $-
  // --$ Lifetime $--
  explicit ParserTables(pmt::util::smrt::GenericId::IdType min_id_); 
  ...
  // --$ Other $--
  void set_parser_state_machine(pmt::util::smct::StateMachine state_machine_);
  void set_lookahead_state_machine(pmt::util::smct::StateMachine state_machine_);

  auto get_parser_state_machine() const -> pmt::util::smct::StateMachine const&;
  auto get_lookahead_state_machine() const -> pmt::util::smct::StateMachine const&;
