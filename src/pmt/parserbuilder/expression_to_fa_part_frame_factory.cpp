...
auto ExpressionToFaPartFrameFactory::construct(GenericAst::AstPositionConst position_) -> ExpressionToFaPartFrameBase::FrameHandle {
  ...
  switch (id) {
    ...
    case GrmAst::NtTerminalDefinition:
      return construct(GenericAst::AstPositionConst{position_.first->get_child_at(position_.second), 0});
    default: {
