...
private:
 ...
 std::vector<std::vector<pmt::rt::FinalIdType>> _state_final_ids_cache;
...
public:
 ...
 auto get_state_final_id(pmt::rt::StateNrType state_nr_, size_t index_) const -> pmt::rt::FinalIdType override;
