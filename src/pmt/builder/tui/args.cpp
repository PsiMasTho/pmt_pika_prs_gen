...
Args::Args(int argc_, char const* const* argv_) {
 ...
 try_open_required_file_from_optional_arg(cmdl, "pika-program-header-skel-file", _pika_program_header_skel_file, "/home/pmt/repos/pika_parser_generator/skel/pmt/builder/pika_program-skel.hpp");
 try_open_required_file_from_optional_arg(cmdl, "pika-program-source-skel-file", _pika_program_source_skel_file, "/home/pmt/repos/pika_parser_generator/skel/pmt/builder/pika_program-skel.cpp");
 ...
 try_open_required_file_from_optional_arg(cmdl, "id-strings-skel-file", _id_strings_skel_file, "/home/pmt/repos/pika_parser_generator/skel/pmt/builder/id_strings-skel.hpp");
 try_open_file_from_arg(cmdl, "id-constants-output-file", _id_constants_output_file);
 try_open_required_file_from_optional_arg(cmdl, "id-constants-skel-file", _id_constants_skel_file, "/home/pmt/repos/pika_parser_generator/skel/pmt/builder/id_constants-skel.hpp");
