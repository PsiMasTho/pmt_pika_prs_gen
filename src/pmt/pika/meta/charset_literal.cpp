...
namespace {
auto interval_from_ast(pmt::pika::rt::Ast const& ast_) -> CharsetLiteral::IntervalType {
...
auto charset_from_ast(pmt::pika::rt::Ast const& ast_) -> CharsetLiteral::SetType {
...
CharsetLiteral::CharsetLiteral(pmt::pika::rt::Ast const& ast_) {
 switch (ast_.get_id()) {
  case Ids::Charset:
...
namespace std {
auto hash<pmt::pika::meta::CharsetLiteral>::operator()(pmt::pika::meta::CharsetLiteral const& literal_) const -> size_t {
