...
PMT_FW_DECL_NS_CLASS(pmt::pika::meta, CharsetLiteral);
...
auto get_string_body_characters() -> pmt::container::IntervalSet<pmt::pika::rt::SymbolType> const&;
...
// Supports bases [2, 36]
auto character_to_integer_literal(pmt::pika::rt::SymbolType symbol_, size_t base_ = 10) -> std::string;
...
auto character_to_grammar_string(pmt::pika::rt::SymbolType symbol_) -> std::string;
...
auto interval_to_range_grammar_string(pmt::container::Interval<pmt::pika::rt::SymbolType> interval_) -> std::string;
