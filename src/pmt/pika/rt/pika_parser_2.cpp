...
auto make_string_node(std::string_view input_, MemoTable::Key const& key_, MemoTable::Match const& match_) -> pmt::pika::rt::Ast::UniqueHandle {
 pmt::pika::rt::Ast::UniqueHandle node = pmt::pika::rt::Ast::construct(pmt::pika::rt::Ast::Tag::String, pmt::pika::rt::ReservedIds::IdDefault);
...
void process_and_add_child(pmt::pika::rt::Ast& parent_, pmt::pika::rt::Ast::UniqueHandle child_, MemoTable::Key const& child_key_, PikaTablesBase const& pika_tables_) {
 if (!child_) {
  return;
 }
...
auto build_ast(MemoTable::IndexType const& root_match_index_, MemoTable const& memo_table_, std::string_view input_, PikaTablesBase const& pika_tables_) -> pmt::pika::rt::Ast::UniqueHandle {
 ...
 struct Frame {
  ...
  pmt::pika::rt::Ast::UniqueHandle _ast_node;
 };

 std::vector<Frame> stack;
 stack.push_back(Frame{root._index, root._key, root._match, 0, pmt::pika::rt::Ast::construct(pmt::pika::rt::Ast::Tag::Parent, pmt::pika::rt::ReservedIds::IdUninitialized)});

 pmt::pika::rt::Ast::UniqueHandle result;
 ...
 while (!stack.empty()) {
  ...
  if (frame._next_child_idx >= match._matching_subclauses.size()) {
   pmt::pika::rt::Ast::UniqueHandle completed = std::move(frame._ast_node);
  ...
  if (is_parent_tag(child_tag)) {
   stack.push_back(Frame{child._index, child._key, child._match, 0, pmt::pika::rt::Ast::construct(pmt::pika::rt::Ast::Tag::Parent, pmt::pika::rt::ReservedIds::IdUninitialized)});
...
auto PikaParser::memo_table_to_ast(MemoTable const& memo_table_, std::string_view input_, PikaTablesBase const& pika_tables_) -> pmt::pika::rt::Ast::UniqueHandle {
 MemoTable::IndexType const start_match_index = find_start_match_index_if_success(memo_table_, input_, pika_tables_);
 if (start_match_index == MemoTable::MemoIndexMatchNotFound) {
  return nullptr;
 }

 pmt::pika::rt::Ast::UniqueHandle ast_root = pmt::pika::rt::Ast::construct(pmt::pika::rt::Ast::Tag::Parent, pmt::pika::rt::ReservedIds::IdRoot);
