...
auto AstToString::id_to_string_internal(IdType id_) const -> std::string {
 return ReservedIds::is_reserved_id(id_) ? ReservedIds::id_to_string(id_) : _id_to_string_fn(id_);
}
