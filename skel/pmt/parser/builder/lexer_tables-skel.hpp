...
class /* $replace CLASS_NAME */ : public pmt::parser::rt::LexerTablesBase {
 public:
  // -$ Functions $-
  ...
  auto get_linecount_state_nr_next(pmt::sm::StateNrType state_nr_, pmt::sm::SymbolType symbol_) const -> pmt::sm::StateNrType override;
  auto is_linecount_state_nr_accepting(pmt::sm::SymbolType state_nr_) const -> bool override;
};
