...
#-- pmt_util_smct --
PMT_UTIL_SMCT_DIR	= ${SRC_DIR}/pmt/util/smct
PMT_UTIL_SMCT_SRC	= $(wildcard ${PMT_UTIL_SMCT_DIR}/*.cpp)
PMT_UTIL_SMCT_HDR	= $(wildcard ${PMT_UTIL_SMCT_DIR}/*.hpp)
PMT_UTIL_SMCT_OBJ	= $(patsubst %.cpp, %.o, ${PMT_UTIL_SMCT_SRC})
PMT_UTIL_SMCT_LIB	= ${PMT_UTIL_SMCT_DIR}/libpmt_util_smct.a
ALL_OBJ	+= ${PMT_UTIL_SMCT_OBJ}
ALL_LIBS	+= ${PMT_UTIL_SMCT_LIB}
ALL_SRC	+= ${PMT_UTIL_SMCT_SRC}
ALL_HDR	+= ${PMT_UTIL_SMCT_HDR}
${PMT_UTIL_SMCT_LIB}: ${PMT_UTIL_SMCT_OBJ}
pmt_util_smct: ${PMT_UTIL_SMCT_LIB}

#-- pmt_util_smrt --
PMT_UTIL_SMRT_DIR	= ${SRC_DIR}/pmt/util/smrt
PMT_UTIL_SMRT_SRC	= $(wildcard ${PMT_UTIL_SMRT_DIR}/*.cpp)
PMT_UTIL_SMRT_HDR	= $(wildcard ${PMT_UTIL_SMRT_DIR}/*.hpp)
PMT_UTIL_SMRT_OBJ	= $(patsubst %.cpp, %.o, ${PMT_UTIL_SMRT_SRC})
PMT_UTIL_SMRT_LIB	= ${PMT_UTIL_SMRT_DIR}/libpmt_util_smrt.a
ALL_OBJ	+= ${PMT_UTIL_SMRT_OBJ}
ALL_LIBS	+= ${PMT_UTIL_SMRT_LIB}
ALL_SRC	+= ${PMT_UTIL_SMRT_SRC}
ALL_HDR	+= ${PMT_UTIL_SMRT_HDR}
${PMT_UTIL_SMRT_LIB}: ${PMT_UTIL_SMRT_OBJ}
pmt_util_smrt: ${PMT_UTIL_SMRT_LIB}
...
${PMT_PARSERBUILDER_EXE_BIN}: ${PMT_PARSERBUILDER_EXE_OBJ} ${PMT_PARSERBUILDER_LIB} ${PMT_UTIL_SMRT_LIB} ${PMT_UTIL_SMCT_LIB} ${PMT_UTIL_LIB} ${PMT_BASE_LIB} ${PMT_LIB}
	${CXX} ${CXXFLAGS} ${INCS} -o $@ $^
