...
def main() -> None:
    ...
    meta_dir = repo_root / "src" / "pmt" / "pika" / "meta"
    debug_build_dir = repo_root / "build" / "debug"

    cmd = [
        "pmt_pika_prs_gen_cli",
        "--start-rules", "grammar",
        "--input-grammar", str(meta_dir / "grammar.pika"),
        "--header-include-path", "pmt/pika/meta/pika_tables.hpp",
        "--id-constants-include-path", "pmt/pika/meta/id_constants-inl.hpp",
