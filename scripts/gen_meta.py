...
def main() -> None:
    ...
    cmd = [
        ...
        "--pika-tables-header-include-filename", "pmt/meta/pika_tables.hpp",
        "--pika-tables-output-header-file", str(meta_dir / "pika_tables.hpp"),
        "--pika-tables-header-skel-file", str(repo_root / "skel" / "pmt" / "builder" / "pika_tables-skel.hpp"),
        "--pika-tables-output-source-file", str(meta_dir / "pika_tables.cpp"),
        "--pika-tables-source-skel-file", str(repo_root / "skel" / "pmt" / "builder" / "pika_tables-skel.cpp"),
        "--pika-tables-class-name", "PikaTables",
        "--pika-tables-namespace-name", "pmt::meta",
